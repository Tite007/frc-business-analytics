        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {isAuthenticated && user && (
              <div className="mb-6">
                <p className="text-lg md:text-xl text-blue-200">
                  ...
                  {user.role && (
                    <span className="text-yellow-300 ml-2">({user.role})</span>
                  )}
                  !
                </p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-12">
              ...
              <Link
                href="/analysis"
                className="w-full sm:w-auto border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105 text-lg"
              >
                View Analysis
              </Link>
              {/* Admin CMS Access */}
              {user?.role === "admin" && (
                <Link
                  href="/cms"
                  className="w-full sm:w-auto bg-yellow-500 text-black px-8 py-4 rounded-lg font-semibold hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105 text-lg"
                >
                  Content Management
                </Link>
              )}
